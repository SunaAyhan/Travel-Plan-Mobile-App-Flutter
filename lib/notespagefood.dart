...
class NotesYemek extends StatefulWidget {
  const NotesYemek({Key? key}) : super(key: key);

  @override
  _NotesYemekState createState() => _NotesYemekState();
}

class _NotesYemekState extends State<NotesYemek> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: noteHeading.length > 0
          ? buildNotes()
          : const Center(child: Text("Not Ekle...")),
